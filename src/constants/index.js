...
export const featuredStoryData = [
  {
    name: "Bola + Ademola",
    title:
      "Taditional Wedding with Killer reception and straight up Party vibes",
    remark:
  ...
  {
    name: "Chima + Amara",
    title: "Court Wedding with amazing friends",
    remark:
  ...
  {
    name: "Benji + Racheal",
    title: "Taditional Wedding and reception and straight up Party vibes",
    remark:
